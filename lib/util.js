...
module.exports = {
	require:function (requirePath) {
		return require(path.join(basePath,requirePath));
	},
	...
	checkRandom:function(numerator, denominator) {
		var _rnd = this.getRandom(1, denominator);
		return numerator >= _rnd;
	},
