...
ItemStorageBase.prototype.count = function(storageType) {
	var _count = 0;
...
ItemStorageBase.prototype.isFull = function(storageType) {
	return this.count(storageType) >= this.limit[storageType];
}
