...
Player.getByID = function(playerID, callback) {
	PlayerAccess.getByID(playerID,
		function(err, playerData){
			...
			_player.bag = new ItemStorageBase(settings.game.storageType.bag);
			_player.storage = new ItemStorageBase(settings.game.storageType.storage);
			_player.equipment = new ItemStorageBase(settings.game.storageType.equipment);
