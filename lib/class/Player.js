...
Player.prototype.removeCityRroom(){
	if (this.build)
		this.leaveRoom(this.build.room);
}
...
Player.prototype.joinMapRoom = function(mapID) {
	if (this.mapRoom)
		this.leaveRoom(this.mapRoom);

	this.mapRoom = 'map_' + mapID;
	this.joinRoom(this.mapRoom);
}
